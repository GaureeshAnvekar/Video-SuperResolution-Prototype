...
#This script is run everytime when we run test script

parser = argparse.ArgumentParser(description="NAS Super-resolution")

# Directory
#parser.add_argument("--data_root", type=str, default="data")
parser.add_argument("--data_root", type=str, default="./videos")
...
parser.add_argument("--data_name", type=str, help="dataset name (e.g., news)", default="segments240p/fragSegments240p/")
...
opt.result_dir= opt.result_root
